...
public class threelevelfinish : MonoBehaviour
{
    [Header("UI Elements")]
    ...
    private const int RequiredScore = 70;
    ...
    private IEnumerator HandleLevelCompletion(Transform player, Animator playerAnimator)
    {
        ...
        {
            levelCompleteText.text = "DEFEAT! Score at least 70!";
    ...
    {
        return ThreelevelScore.instance != null ? ThreelevelScore.instance.currentScore : 0;
    }
    ...
    public void RetryGame()
    {
        ...
        Debug.Log("All Question Panels Re-enabled!");
        ...
        if (ThreelevelScore.instance != null)
        {
            ThreelevelScore.instance.ResetScoreOnNewLevel();
        }
    ...
    FindObjectOfType<SkyboxChanger>().SetSkybox(3); // For Level 4
