...
public class FinishLineLevel2 : MonoBehaviour
{
    ...
    private IEnumerator HandleLevelCompletion(Transform player, Animator playerAnimator)
    {
        ...
        {
            levelCompleteText.text = "DEFEAT! Score at least 50!";
    ...
    {
        return Leveltwo.instance != null ? Leveltwo.instance.currentScore : 0;
    }
    ...
    public void NextLevel()
{
    ...
    FindObjectOfType<SkyboxChanger>().SetSkybox(2); // For Level 3
